...
<li>You can create an ish bookmarklet and add it to your bookmarks (don't forget to change *yourdomain.com*): <code>javascript:location.href='http://yourdomain.com/index.php?title='+document.title+'&url='+window.location.href</code></li>
</ol>
